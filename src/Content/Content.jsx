...
import Card from "../componant/CardTemplate/Card";
import Analytics from "../componant/AnalyticsTemplate/Analytics";
import CircularProgress from "../componant/CircularProgress/CircularProgress";
...
const Content = () => {
  ...
  return (
    ...
    <div className="row header">
    <Card Icon={AiOutlineUsergroupAdd} title="Followers" value=" 8:)" />
...
<div className="tools">
  ...
  <div className="row tall-square inv-bg">
        ...
        <div className="tall-square-header">
          <div className="left">
      ...
      <div className="row side-rect">
        <section>
          ...
          <div className="more-details">
            <h1 className="summary-title">Detailed Analysis</h1>
            <span className="txt">
